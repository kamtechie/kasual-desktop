...
control operations over a JSON-speaking CLI, so the polling/cache/emitter
machinery and the /proc PID expansion live here; each subclass supplies only the
